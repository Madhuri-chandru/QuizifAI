...
// Navbar-icons
import QuizifAilogo from "../../src/assets/Images/Quiz-Master/Quizifai-logo.png";
import Dashboard from "../../src/assets/Images/Quiz-Master/Dashboard.png";
import Quiz from "../../src/assets/Images/Quiz-Master/Quiz.png";
import History from "../../src/assets/Images/Quiz-Master/History.png";
import Schedule from "../../src/assets/Images/Quiz-Master/Schedule.png";
import Notification from "../../src/assets/Images/Quiz-Master/Notification.png";
import QuizAdmin from "../../src/assets/Images/Quiz-Master/QuizAdmin.png";
import Profile from "../../src/assets/Images/Quiz-Master/Profile.png";

// Main-icons
import Plus from "../../src/assets/Images/Quiz-Master/Plus.png";
import AdminUser from "../../src/assets/Images/Quiz-Master/Admin-User.png";
import Search from "../../src/assets/Images/Quiz-Master/Search.png";
import Menu from "../../src/assets/Images/Quiz-Master/Menu.png";
import Topic from "../../src/assets/Images/Quiz-Master/Topic.png";
import Timer from "../../src/assets/Images/Quiz-Master/Timer.png";
import Easy from "../../src/assets/Images/Quiz-Master/Easy.png";
import Star from "../../src/assets/Images/Quiz-Master/Star.png";
import Play from "../../src/assets/Images/Quiz-Master/Play.png";
import Pencil from "../../src/assets/Images/Quiz-Master/Pencil.png";
import ThreeStar from "../../src/assets/Images/Quiz-Master/3-Stars.png";
import Share from "../../src/assets/Images/Quiz-Master/Share.png";
import Dropdown from "../../src/assets/Images/Quiz-Master/Dropdown.png";

// Logout-icons
import LArrow from "../../src/assets/Images/Quiz-Master/Logout-arrow.png";
import LWhitebox from "../../src/assets/Images/Quiz-Master/Logout-Whitebox.png";
import LRound from "../../src/assets/Images/Quiz-Master/Logout-round.png";
import UserOutline from "../../src/assets/Images/Quiz-Master/User-Outline.png";
import User from "../../src/assets/Images/Quiz-Master/User.png";
import Scored from "../../src/assets/Images/Quiz-Master/Scored.png";
import Timespent from "../../src/assets/Images/Quiz-Master/Time-spent.png";
import Bell from "../../src/assets/Images/Quiz-Master/Bell.png";
import Todaytopic from "../../src/assets/Images/Quiz-Master/Today-Topic.png";
import Mail from "../../src/assets/Images/Quiz-Master/Mail.png";
...
function quizmaster() {
  return (
    <>
      <div className="flex">
        {/* Navigation-Section */}
        <header className="w-[219px] h-[1056px] absolute top-[-19px] left-[-9px] rounded-tl-[20px] rounded-bl-[20px] bg-[#F5F5FB]">
          ...
          <div className="flex w-[28px] h-[30px] absolute top-[511px] left-[44px]">
            <img src={QuizAdmin} alt="QuizAdmin Image" />
            <a className="ml-3 -mt-0.5 text-Poppins font-medium text-[15px] leading-[22.5px] text-[#9696BB] text-nowrap">
              Quiz Admin
            </a>
          </div>

          <div className="flex w-[17px] h-[17px] absolute top-[568px] left-[51px]">
        ...
        {/* Logout-Section */}
        <footer className="w-[272px] h-[1036px] absolute left-[989px] rounded-tr-[20px] rounded-br-[20px] bg-[#F5F5FB]">
