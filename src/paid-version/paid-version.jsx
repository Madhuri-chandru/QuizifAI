...
import Quiz from "../assets/Images/Org-Admin/Quiz 1.png";
...
// import ToggleOutline from "../../public/Assets/Toggle-outline.png";
// import ToggleWhite from "../../public/Assets/Toggle-white.png";
...
function page() {
  ...
  return (
    <>
      <div className="flex">
        {/* Navigation-Section */}
        <header className="w-[219px] h-[1056px] absolute top-[-19px] left-[-9px] rounded-tl-[20px] rounded-bl-[20px] bg-[#F5F5FB] z-10 shadow-lg shadow-gray-400/60 ">
        ...
        <main className="mx-auto">
          ...
          <div className="w-[99px] h-[41px] absolute top-[49px] left-[767px] rounded-[10px] bg-[#FFEDCD]">
            <div className="flex">
         ...
         <div className="flex text-nowrap w-[292px] h-[21px] absolute top-[187px] left-[248px]">
        <h1 className="font-Poppins font-medium text-[15px] leading-[22.5px]">
        Latest Quiz
        </h1>
        <h1 className="ml-[489px] font-Poppins font-normal text-[12px] leading-[18px]">
        My Quiz’s
        </h1>
         </div>

         {/* <div className="flex absolute top-[198px] left-[881px]">
          <img className="w-[68px] h-[23px] -mt-4" src={ToggleOutline} alt="toggle"/>
          <img className="w-[16px] h-[16px] boredr border-black -ml-10 -mt-3" src={ToggleWhite} alt="toggle"/>
        </div> */}
        ...
        {/* Logout-Section */}
        <footer className="w-[272px] h-[1036px] absolute left-[989px] rounded-tr-[20px] rounded-br-[20px] bg-[#F5F5FB] z-10 shadow-lg shadow-gray-400/60 ">
