...
import UserAdmin from "../../src/assets/Images/Detailed-Report/User-Admin.png";
import Reports from "../../src/assets/Images/Detailed-Report/Report.png";
import Profile from "../../src/assets/Images/quiz-type/Profile.png";

// Main-Section-icons
import Round from "../../src/assets/Images/User-Administration/Round.png";
import CreateReport from "../../src/assets/Images/User-Administration/Create-report.png";
import CreateUser from "../../src/assets/Images/User-Administration/Create-User.png";
import Horizontal from "../../src/assets/Images/User-Administration/Horizontal.png";
import Logo from "../../src/assets/Images/User-Administration/Logo.png";
import OrgName from "../../src/assets/Images/User-Administration/Org-Name.png";
import OrgDiscription from "../../src/assets/Images/User-Administration/Org-Dis.png";
import Edit from "../../src/assets/Images/User-Administration/Edit.png";
import Delete from "../../src/assets/Images/User-Administration/Edit.png";
import Name from "../../src/assets/Images/User-Administration/Name.png";
import OrgAddress from "../../src/assets/Images/User-Administration/Org-Add.png";
import Phone from "../../src/assets/Images/User-Administration/Phone-no.png";
import Subscription from "../../src/assets/Images/User-Administration/Subscription.png";
import Dropdown from "../../src/assets/Images/User-Administration/Dropdown.png";
import View from "../../src/assets/Images/User-Administration/View.png";
import TableEdit from "../../src/assets/Images/User-Administration/Table-Edit.png";
import TableDelete from "../../src/assets/Images/User-Administration/Table-Delete.png";
...
function useradmin() {
  return (
    <>
      <div className="">
        {/* Navigation-Section */}
        <header className="w-[219px] h-[1200px] absolute top-[-19px] left-[-9px] rounded-tl-[20px] rounded-bl-[20px] bg-[#F5F5FB] z-10 shadow-lg shadow-gray-500/60">
          ...
          <div className="flex w-[28px] h-[30px] absolute top-[508px] left-[51px]">
            <img className="-ml-1" src={UserAdmin} alt="QuizAdmin Image" />
            <a
          ...
          <div className="flex w-[17px] h-[17px] absolute top-[581px] left-[51px]">
            <img src={Reports} alt="Profile Image" />
            <a
