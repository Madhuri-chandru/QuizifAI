...
// Navbar-icons
import QuizifAilogo from "../assets/Images/Free-Quiz/Quizifai 1.png";
import Dashboard from "../assets/Images/Free-Quiz/Dashboard.png";
import Quiz from "../assets/Images/Free-Quiz/Quiz.png";
import History from "../assets/Images/Free-Quiz/History.png";
import Schedule from "../assets/Images/Free-Quiz/Schedule.png";
import Notification from "../assets/Images/Free-Quiz/Notification.png";
import Profile from "../assets/Images/Free-Quiz/Profile.png";


// Main-icons
import Search from "../assets/Images/Free-Quiz/Search.png";
import Menu from "../assets/Images/Free-Quiz/Menu.png";
import Topic from "../assets/Images/Free-Quiz/Topic.png";
import Timer from "../assets/Images/Free-Quiz/Timer.png";
import Easy from "../assets/Images/Free-Quiz/Easy.png";
import Star from "../assets/Images/Free-Quiz/Star.png";
import Play from "../assets/Images/Free-Quiz/Play.png";
import Pencil from "../assets/Images/Free-Quiz/Pencil.png";
import ThreeStar from "../assets/Images/Free-Quiz/3-Stars.png";
import Share from "../assets/Images/Free-Quiz/Share.png";
import Dropdown from "../assets/Images/Free-Quiz/Dropdown.png";


// Logout-icons 
  import LArrow from "../assets/Images/Free-Quiz/Logout-arrow.png"
  import LWhitebox from "../assets/Images/Free-Quiz/Logout-Whitebox.png"
  import LRound from "../assets/Images/Free-Quiz/Logout-round.png"
  import UserOutline from "../assets/Images/Free-Quiz/User-Outline.png"
  import User from "../assets/Images/Free-Quiz/User.png"
  import Scored from "../assets/Images/Free-Quiz/Scored.png"
  import Timespent from "../assets/Images/Free-Quiz/Time-spent.png"
  import Bell from "../assets/Images/Free-Quiz/Bell.png"
  import Todaytopic from "../assets/Images/Free-Quiz/Today-Topic.png"
  import Mail from "../assets/Images/Free-Quiz/Mail.png"
    ...
    <>
      <div className="flex">
        ...
        <div className="flex w-[15px] h-[15px] absolute top-[231px] left-[51px]">
          ...
          <a className="ml-5 -mt-0.5 text-Poppins font-medium text-[15px] leading-[22.5px] text-[#9696BB]">Dashboard</a>
        </div>

        <div className="flex w-[16px] h-[15px] absolute top-[285px] left-[51px]">
          <img src={Quiz} alt="Quiz's img"/>
          <a className="ml-5 -mt-0.5 text-Poppins font-medium text-[15px] leading-[22.5px] text-[#30304F]">Quiz</a>
        </div>

        <div className="flex w-[13.87px] h-[15.41px] absolute top-[338px] left-[51px]">
          <img src={History} alt="History img"/>
          <a className="ml-5 -mt-0.5 text-Poppins font-medium text-[15px] leading-[22.5px] text-[#9696BB]">History</a>
        </div>

        <div className="flex w-[17px] h-4 absolute top-[394px] left-[51px]">
          <img src={Schedule} alt="Schedule img"/>
          <a className="ml-4 -mt-0.5 text-Poppins font-medium text-[15px] leading-[22.5px] text-[#9696BB]">Schedule</a>
        </div>

        <div className="flex w-4 h-[15px] absolute top-[453px] left-[51px]">
          <img src={Notification} alt="Notification img"/>
          <a className="ml-4 -mt-0.5 text-Poppins font-medium text-[15px] leading-[22.5px] text-[#9696BB]">Notification</a>
        </div>

        <div className="flex w-[17px] h-[17px] absolute top-[510px] left-[51px]">
          <img src={Profile} alt="Profile img"/>
          <a className="ml-4 -mt-0.5 text-Poppins font-medium text-[15px] leading-[22.5px] text-[#9696BB]">Profile</a>
        </div>
        ...
        Sort By
         ...
         <div className="flex">
           <div className=" rounded-lg w-[133px] flex border-solid border-gray-300 border-[2px] absolute top-[625px] left-[248px]">
               <div className=" border-grey-400 leading-[18px] text-[12px] font-medium  px-4 py-3 rounded cursor-pointer">Toughness</div>
               <img className="w-5 h-5 flex mt-3" src={Dropdown} alt="Dropdown Icon for Division"/>
              </div>

              <div className=" rounded-lg w-[225px] flex border-solid border-gray-300 border-[2px] absolute top-[625px] left-[402px]">
               <div className=" border-grey-400 leading-[18px] text-[12px] font-medium  px-4 py-3 rounded cursor-pointer text-nowrap">Topics</div>
               <img className="w-5 h-5 flex mt-3 ml-28" src={Dropdown} alt="Dropdown Icon user name"/>
              </div> 
